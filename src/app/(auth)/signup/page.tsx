    ...
    >
      ...
      <div className="rounded-[24px] border border-white/60 bg-white/70 p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.7)_inset,0_1px_2px_rgba(0,0,0,0.01),0_8px_32px_rgba(17,24,39,0.04)] backdrop-blur-2xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div>
            <label htmlFor="name" className="mb-2 block text-[13px] font-medium text-slate-700">Full Name</label>
            <input
              id="name"
              type="text"
              value={name}
          ...
          <div>
            <label htmlFor="password" className="mb-2 block text-[13px] font-medium text-slate-700">Password</label>
        ...
        <p className="mt-6 text-center text-[12px] text-slate-400">
          By signing up, you agree to our <Link href="#" className="underline hover:text-slate-600">Terms</Link> & <Link href="#" className="underline hover:text-slate-600">Privacy</Link>.
        </p>
      </div>

      <p className="mt-8 text-center text-[13px] text-slate-500">
        Already have an account?{" "}
        <Link href="/login" className="font-semibold text-slate-900 transition-colors hover:text-stone-600">
          Log in here
        </Link>
      </p>
    </motion.div>
