...
const categoryColors: Record<string, string> = {
  ...
  Security: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
  "Case Study": "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400",
  Vision: "bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400",
    ...
    <div className="px-6 py-20">
      <div className="mx-auto max-w-6xl">
        ...
        {featured && (
          ...
          >
            <Card className="group mb-12 cursor-pointer rounded-2xl p-8 transition-all duration-300 hover:border-accent hover:shadow-xl">
              <Badge className="mb-4 bg-accent-light text-accent">
                Featured
              </Badge>
              <h2 className="mb-3 text-2xl font-semibold text-foreground group-hover:text-accent md:text-3xl">
                {featured.title}
              </h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {rest.map((post, i) => (
            <motion.article
              ...
              viewport={{ once: true }}
            >
              <Card className="group h-full cursor-pointer rounded-2xl p-6 transition-all duration-300 hover:border-accent hover:shadow-lg">
                <span
