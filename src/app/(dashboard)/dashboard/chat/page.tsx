...
const sampleConversation: Message[] = [
  {
    ...
    role: "user",
    content:
      "Build a responsive navbar component with a mobile hamburger menu using Next.js and Tailwind CSS.",
  },
  {
    id: 2,
    role: "assistant",
        ...
        prev.map((m) =>
          m.isLoading
            ? {
                ...
                isLoading: false,
                content:
                  "I'll help you with that. Let me analyze the requirements and provide a solution...",
              }
            : m
        )
      );
            ...
            {rightPanel === "browser" && (
              <div className="flex flex-1 items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400">Enter a URL to browse</p>
                </div>
              </div>
            )}
            {rightPanel === "terminal" && (
