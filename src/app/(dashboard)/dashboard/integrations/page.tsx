      ...
      <div className="w-full max-w-md rounded-xl border border-gray-200 bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 text-[12px] font-bold text-gray-600">
              {meta.icon}
            </div>
        ...
        <div className="space-y-4 px-5 py-5">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-[13px] text-gray-900 outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-50"
            />
          </div>
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 transition-shadow hover:shadow-md">
      ...
      {(secretSummary || Object.keys(integration.configHints).length > 0) && (
        <div className="mt-3 space-y-1 rounded-lg bg-gray-50 px-3 py-2 text-[11px] text-gray-500">
        ...
        {!activeWorkspace && !projectLoading ? (
          ...
          <div className="space-y-8">
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 rounded-full border border-gray-200 px-2.5 py-1 text-[11px] font-medium text-gray-600 hover:bg-gray-50 disabled:opacity-50"
                      >
                        <Plus size={12} />
                        Connect
                      </button>
              ...
              <div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {visibleComingSoon.map((p) => (
                    <div
                      key={p.id}
                      className="rounded-xl border border-gray-200 bg-white/60 p-5 opacity-70"
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100 text-[12px] font-bold text-gray-400">
                            {p.icon}
                          </div>
                          <div>
            ...
            {visibleCatalog.length === 0 && visibleComingSoon.length === 0 ? (
              <div className="rounded-xl border border-dashed border-gray-200 bg-gray-50 p-10 text-center text-[13px] text-gray-500">
